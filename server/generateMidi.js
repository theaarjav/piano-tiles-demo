...
import { generateRowComp, compInitNotes, setCompGameOn, getCompGameOn } from './src/competition.js';
...
//   song=selectedSong;
// }
// const midiData = fs.readFileSync('./midis/jamal_kudu.mid');
...
export const printNotes = (io) => {
  if (io) {
    ...
    if (currentIndex >= keysArray.length) {
      if (getMode() == 'classic') stopSongClassic(io);
      else stopSongComp(io);
      return;
    }
